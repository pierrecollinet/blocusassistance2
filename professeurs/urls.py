...
from professeurs.views import send_rapport_module, display_rapport_module, display_rapport_global, send_rapport_global
urlpatterns = [
    # PROFIL PROFESSEURS
    ...
    url('^voir-rapport-global/(?P<pk_etudiant>\d+)$', display_rapport_global, name="display-rapport-global"),
    url('^send-rapport-global/(?P<pk_etudiant>\d+)$', send_rapport_global, name="send-rapport-global"),
