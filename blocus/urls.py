...
from blocus.views import inscription_blocus, blocus_assistes, confirmation_inscription, ajax_get_modules, ajax_calculate_price, checkout, detail_blocus, imprimer_planning, cocher_presence
